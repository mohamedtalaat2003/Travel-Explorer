...
{
    public class UpdateFlightScheduleCommandValidator : AbstractValidator<UpdateFlightScheduleCommand>
    {
        public UpdateFlightScheduleCommandValidator()
        {
            RuleFor(x => x.Id)
                .GreaterThan(0).WithMessage("Flight schedule ID is required and must be greater than 0.");
