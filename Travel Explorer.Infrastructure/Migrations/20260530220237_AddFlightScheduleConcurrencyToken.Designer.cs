...
namespace Travel_Explorer.Infrastructure.Migrations
{
    ...
    [Migration("20260530220237_AddFlightScheduleConcurrencyToken")]
    partial class AddFlightScheduleConcurrencyToken
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Travel_Explorer.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<int>("requestToBeAuthor")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Travel_Explorer.Domain.Entities.DestinationBooking", b =>
                {
                    ...
                    b.HasIndex("PaymentId")
                        .IsUnique()
                        .HasDatabaseName("IX_destinationBookings_PaymentId");
            ...
            modelBuilder.Entity("Travel_Explorer.Domain.Entities.FlightBooking", b =>
                {
                    ...
                    b.HasIndex("PaymentId")
                        .IsUnique()
                        .HasDatabaseName("IX_flightBookings_PaymentId");
            ...
            modelBuilder.Entity("Travel_Explorer.Domain.Entities.UserRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Travel_Explorer.Domain.Entities.DestinationBooking", b =>
                {
                    ...
                    b.HasOne("Travel_Explorer.Domain.Entities.PaymentTransaction", "Payment")
                        .WithOne()
                        .HasForeignKey("Travel_Explorer.Domain.Entities.DestinationBooking", "PaymentId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Travel_Explorer.Domain.Entities.FlightBooking", b =>
                {
                    ...
                    b.HasOne("Travel_Explorer.Domain.Entities.PaymentTransaction", "Payment")
                        .WithOne()
                        .HasForeignKey("Travel_Explorer.Domain.Entities.FlightBooking", "PaymentId")
                        .OnDelete(DeleteBehavior.SetNull);
